        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-8 items-center">
          ...
          >
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold leading-[1.1] text-brand-dark mb-6 tracking-tight">
              We Run the{' '}
              <span className="text-brand-primary relative whitespace-nowrap">
                Entire Transition
                <svg
                  className="absolute w-full h-3 -bottom-1 left-0 text-brand-primary opacity-30"
                  viewBox="0 0 100 10"
            ...
            <p className="text-lg md:text-xl text-gray-600 mb-8 leading-relaxed max-w-2xl mx-auto lg:mx-0">
              We’re not movers. We’re end-to-end project managers who handle the sorting, vendors,
              logistics, move-day oversight, and white-glove setup — so your loved one walks into a
              fully settled home and your family stays focused on each other.
            </p>

            <div className="flex flex-col sm:flex-row items-center justify-center lg:justify-start gap-4 mb-10">
              <Button size="lg" withArrow onClick={() => setView('contact')}>
                Schedule a Private Consultation
              </Button>
              <Button variant="outline" size="lg" onClick={() => setView('our-process')}>
